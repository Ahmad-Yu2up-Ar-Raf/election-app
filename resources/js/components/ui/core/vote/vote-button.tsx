...
const ButtonHover12 = ( {  onClick, disabled , children, className , ...props}: ButtonHover12Props) => {
  return (
    <>
      <Button 
      disabled={disabled}
